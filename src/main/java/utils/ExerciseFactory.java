...
import calendar.year._2015.day10.ElvesLookElvesSay;
...
import calendar.year._2016.day10.BalanceBots;
...
public class ExerciseFactory {
    ...
    private static final Map<LocalDate, Class<? extends Exercise>> exercises = Map.<LocalDate, Class<? extends Exercise>>ofEntries(
            ...
            Map.entry(LocalDate.of(2015, 12, 10), ElvesLookElvesSay.class),
            ...
            Map.entry(LocalDate.of(2016, 12, 10), BalanceBots.class),
            ...
            Map.entry(LocalDate.of(2020, 12, 8), HandheldHalting.class),
            Map.entry(LocalDate.of(2020, 12, 9), EncodingError.class),
